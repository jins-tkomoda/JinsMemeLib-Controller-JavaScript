...
/* Copyright 2018 Taiki Komoda, JINS Corp.   */

var jmctrllib = (function() {
    //Buffers
    var gb = {
    ...
    return {
        ...
        getSequentialSwing: function(data) {
            ...
            if(gb.yaw_swing_in_seq == 1 && (gb.rt_cnt_sw - gb.yaw_swing_fep_cnt > param.yaw_seq_th)){
                var direction = -1 * gb.yaw_swing_fep_sign * ((gb.yaw_swing_seq_cnt % 2) * 2 - 1);
                var event_sw_lat = new CustomEvent('jmctrllib_swing_lat', 
            ...
            if(gb.pitch_swing_in_seq == 1 && (gb.rt_cnt_sw - gb.pitch_swing_fep_cnt > param.pitch_seq_th)){
                var direction = gb.pitch_swing_fep_sign * ((gb.pitch_swing_seq_cnt % 2) * 2 - 1);
                var event_sw_long = new CustomEvent('jmctrllib_swing_long', 
        ...
        getSequentialEyeMove: function(data) {
            ...
            if(gb.em_lat_in_seq == 1 && (gb.rt_cnt_em - gb.em_lat_fep_cnt > param.em_lat_seq_th)){
                var direction = gb.em_lat_fep_sign * ((gb.em_lat_seq_cnt % 2) * 2 - 1); 
            ...
            if(gb.em_long_in_seq == 1 && (gb.rt_cnt_em - gb.em_long_fep_cnt > param.em_long_seq_th)){
                var direction = gb.em_long_fep_sign * ((gb.em_long_seq_cnt % 2) * 2 - 1);
                var event_em_long = new CustomEvent('jmctrllib_eyemove_long', 
        ...
        calcTilt: function(data) {
            ...
            var tilt = Math.atan2(gb.wa_accy,-1 * gb.wa_accz) * 57.3;
            return tilt;
        }
    };
